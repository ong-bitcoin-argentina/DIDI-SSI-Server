...
module.exports = {
  ...
  INDEX: {
    ...
    MSG: {
      ...
      ENDED_WORKER: (pid, code, signal) => `Worker ${pid} termino con código: ${code}, y señal: ${signal}`,
    },
  },
  ISSUER: {
    ERR: {
